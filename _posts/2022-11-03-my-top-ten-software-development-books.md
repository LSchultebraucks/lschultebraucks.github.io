...
![Clean Code Book cover]({{site.url}}/assets/img/cleanCode_book_cover.jpg){: loading="lazy" decoding="async"}
...
![Clean Architecture book cover]({{site.url}}/assets/img/cleanArch_book_cover.jpg){: loading="lazy" decoding="async"}
...
![The Clean Coder book cover]({{site.url}}/assets/img/cleanCoder_cover.jpg){: loading="lazy" decoding="async"}
...
![Clean Craftmanship book cover]({{site.url}}/assets/img/cleanCraft_cover.jpg){: loading="lazy" decoding="async"}
...
![Refactoring book cover]({{site.url}}/assets/img/refactoring_book_cover.jpg){: loading="lazy" decoding="async"}
...
![Programatic Programmer book cover]({{site.url}}/assets/img/pragmaticProgrammer_cover.jpg){: loading="lazy" decoding="async"}
...
![Passionate Programmer book cover]({{site.url}}/assets/img/passionateProgrammer_cover.jpg){: loading="lazy" decoding="async"}
...
![Code Head book cover]({{site.url}}/assets/img/codeHead_cover.jpg){: loading="lazy" decoding="async"}
...
![design patterns book cover]({{site.url}}/assets/img/designPatterns_cover.jpg){: loading="lazy" decoding="async"}
...
![code complete book cover]({{site.url}}/assets/img/codeComplete_cover.jpg){: loading="lazy" decoding="async"}
